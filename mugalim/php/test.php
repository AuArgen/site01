   ...
   <div class="container-lg">
      ...
      <form method="post">
         ...
         <div class="form-group">
            ...
            <div class="form-group">
                  <input type="text" class="form-control" name="sulka" placeholder="Тестин ссылкасы" value="">
                </div>
<br>
...
<?
  if(isset($_POST["submit_news"])) {
    ...
    $p = $_POST["predmet_aty"];
    $s = $_POST["sulka"];
    $conn->query("INSERT INTO test(klass_aty,teacher_aty,predmet_aty,sulka_test,date)
      VALUES( '$k','$f','$p','$s',NOW())");
          reload();
        }
        function reload() {
