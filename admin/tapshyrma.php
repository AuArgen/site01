        ...
        <div class="form-group">
            <select class="form-control" name="teacher_aty">
              <option>Мугалимдин аты-жөнү</option>
                    <?php 
                    $result = $conn->query("SELECT * FROM teacher",$link);
                    if (mysqli_num_rows($result) > 0) 
                     {
                        $row = mysqli_fetch_array($result);
                        do
         ...
         <div class="form-group">
            <select class="form-control" name="predmet_aty">
             ...
             <div class="form-group">
                  <input type="text" class="form-control" name="tema" placeholder="Сабактын темасы" value="">
                </div>
           
            <div class="form-group">
                  <input type="text" class="form-control" name="sulka" placeholder="Видео сабактын ссылкасы" value="">
                </div>
