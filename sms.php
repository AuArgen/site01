       ...
       <li>
        ...
        <a href="forma.php"><i id="profill" class="fa fa-user-circle-o" aria-hidden="true"></i> Профиль</a>
              ...
              <div id="page-content-wrapper">
                ...
                <div class="janylyktar">Сообщение</div>
                     ...
                     <div class="col-md-12">
                      <form id="padd"> 
                        ...
                        <select style="margin-bottom: 25px;" class="form-control">
                          <option>Все</option>
                          <option>Входящие сообщение</option>
                          <option>Исходящие сообщение</option>
                        </select>

                        <div id="block-sms" class="col-md-12">
                          <div id="icon-block"><i class="fa fa-envelope" aria-hidden="true"></i></div>
                          <div id="smss">Входящие сообщение  <span class="badge badge-primary badge-pill">2/14</span></div>
                        </div>


                         <div id="block-sms" class="col-md-12">
                          <div id="icon-block"><i class="fa fa-share-square-o" aria-hidden="true"></i></div>
                          <div id="smss">Отправленные сообщение <span class="badge badge-primary badge-pill">12</span></div>
                        </div>

                        

                        <div id="jibeka" class="col-md-12"><i class="fa fa-pencil" aria-hidden="true"></i><a href="send-sms.php">Написать письмо</a> </div>
