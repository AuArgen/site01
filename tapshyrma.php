          ...
          <div class="col-md-12">
           <form id="padd"> 
             ...
             <ul class="nav nav-tabs" id="myTab" role="tablist">
               <li class="nav-item">
                 <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><i id="bicon" class="fa fa-check-circle-o" aria-hidden="true"></i>Задание</a>
               </li>
              <!--  <li class="nav-item">
             ...
             <div class="tab-content" id="myTabContent">
               <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <?php 
                    ...
                    $result = $conn->query("SELECT * FROM tapshyrma INNER JOIN predmet on tapshyrma.klass_aty='{$_SESSION['klass_aty']}' WHERE tapshyrma.predmet_aty=predmet.aty order by date desc");
                 ...
                 <div class="tapshyrma">
                   ...
                   <br>
                    <div class="tema"><i style="color: #009688;" id="bicon" class="fa fa-play" aria-hidden="true"></i>Видео сабак : <span class="tus"> <a href="'.$row["sulka"].'">көрүү</a></span></div>
                    <br>
